...
import icon1 from "../../../../../public/banner/cut.png"

import icon2 from "../../../../../public/banner/call.png"
import icon3 from "../../../../../public/banner/bnr-logo.png"
import icon4 from "../../../../../public/banner/off.png"
import 'swiper/css';
...
// import icon2 from "../../../../../public/banner/slide3.png"
...
const Banner = () => {
    ...
    const slides = [
      {
        avatar: "../../../../../public/banner/slide3.png",
      },
      {
        avatar: "https://download-video.akamaized.net/v3-1/playback/45ba671c-57d3-416d-a83c-815578a54804/8f31ee7c?__token__=st=1708131782~exp=1708146182~acl=%2Fv3-1%2Fplayback%2F45ba671c-57d3-416d-a83c-815578a54804%2F8f31ee7c%2A~hmac=bf9f15e0c0b75907bccc1b4e764239154fb97b2ed201c9184b44c304b8fe04fe&r=dXMtd2VzdDE%3D",
      },
                                  ...
                                  <swiper-slide className='newfold newtown' key={index}>
                                    <div>
                                      <div className="w-[90%] m-auto py-10">
                                        <div className="card">
                                          <video autoPlay controls loop muted  src={testimonial.avatar} className='w-full h-full'></video>
