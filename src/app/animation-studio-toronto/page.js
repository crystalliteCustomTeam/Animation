...
//==== Hero Images
import BannerImg from "media/location-page/toronto.png"
//==== Looking Images
...
const LocationPage = () => {
  ...
  const hero = {
    ...
    para: (
      <>
        Finding the right animation studios in Toronto can feel like a daunting
        task. Whether you need mesmerizing 2D animation studios in Toronto or
        immersive 3D animation Toronto services, the search for quality can be
        overwhelming. That’s where we come in. Our studio stands out as a leader
        among Toronto Animation Companies, delivering unparalleled creativity
        and precision. With a focus on your unique vision, we transform ideas
        into animated works that leave a lasting impression.
      </>
    ),
    btnBg: "bg-prime",
    BannerImg: BannerImg,
  ...
  const Desc2 = {
    title: (
      <>
        ...
        <span className="text-[#FF2D4A]"> Toronto's Competitive Market</span>
      </>
    ),
  ...
  const portfolio = {
    ...
    para: (
      <>
        Our portfolio showcases a diverse collection of projects that highlight
        our expertise in Toronto animation..
      </>
    ),
  ...
  //=====Looking Fold=====//
  const paraArray = [
    `Choosing the right studio is crucial to the success of your project. At Infinity Animations, we bring a unique combination of expertise, cutting-edge technology, and a client-first mindset to every endeavor. With a stellar reputation among Toronto animation studios, we approach each project with a deep understanding of your vision, ensuring that every detail aligns with your objectives. Our team specializes in crafting animations that resonate powerfully with your audience, enhancing brand recognition and delivering measurable results. Partner with us to transform your ideas into impactful animations that inspire, engage, and achieve lasting success.`,
  ]
        ...
        {isMobile
          ...
          : showDesktopComponents && (
              <>
                <HeroBottom />
                <Speedometer
                  title='<span className="text-primary-100">Best</span> Video Animation <br /> Company <span className="text-primary-100"> in Toronto  <br /> </span>  With Diverse Services'
                  desc="As leaders among animation studios Toronto, we pride ourselves on delivering excellence with every frame."
                />
                <Counter />
                <Description content={Desc1} />
                <Portfolio content={portfolio} />
