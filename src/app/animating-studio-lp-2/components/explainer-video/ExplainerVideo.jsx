                        ...
                        <div className="col-span-12 md:col-span-6">
                            <div className="pt-[50px] pb-[25px] lg:py-[90px]">
                                ...
                                <h6 className='text-[15px] lg:text-[18px] text-white leading-[24px] lg:leading-[28px] font-semibold poppins mb-4 lg:pr-8'>
                                    Explain Better. Drive Engagement. Get More Sales.
                                </h6>
                                <p className='text-white text-[13px] lg:text-[14px] xxl:text-[15px] pr-[10px] poppins mb-3 lg:pr-10'>Don't settle for ordinary—capture your audience’s attention with the irresistible allure of animated videos</p>
