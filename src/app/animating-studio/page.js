...
const BrandsThree = React.lazy(() => import('./components/brands3/brands3'));
const BrandsFour = React.lazy(() => import('./components/brands4/brands4'));
...
const Studio = () => {
    ...
    const workListContent = {
        workList: [
            { listTitle: "Discussion", listImage: WorkImg },
            { listTitle: "Concept & Script", listImage: WorkImg },
            { listTitle: "Voiceover", listImage: WorkImg },
            { listTitle: "Illustration", listImage: WorkImg },
            { listTitle: "Animation", listImage: WorkImg, },
            { listTitle: "Music", listImage: WorkImg, },
            { listTitle: "Video Publish", listImage: WorkImg, },
        ]
    }
