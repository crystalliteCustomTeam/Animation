...
const BrandsFour = ({ content }) => {
    ...
    return (
        <>
            <section className='pt-0 md:pt-[50px] lg:pt-[80px] lg:relative px-4 xl:px-0 mt-[70px] mb-[25px]'>
                <div className='px-5 sm:px-8 xl:max-w-7xl mx-auto bg-cover bg-center bg-no-repeat bg-[url("../../public/infinity-studio/brand.svg")] rounded-xl  pt-[25px] md:pt-[5px]'>
                    <div className="grid grid-cols-12">
                        <div className='col-span-12 lg:col-span-6 pb-4 pt-2 lg:py-[25px] xl:py-[40px]'>
                        ...
                        <div className='col-span-12 lg:col-span-6 flex justify-center'>
                            <div className='lg:absolute lg:top-[1%] w-[450px]  2xl:w-[48%] xxl:w-[43%] 3xl:w-[40%] h-full lg:h-auto  mb-0 flex items-end bottom-[-10%] right-0 xl:right-[-3%]'>
