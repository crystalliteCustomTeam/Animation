...
const BrandsFour = ({ content }) => {
    ...
    return (
        <>
            <section className='pt-[50px] lg:pb-[100px] lg:pt-[200px] lg:relative px-4 xl:px-0 bg-white'>
                    ...
                    <div className='px-6 sm:px-10 bg-cover bg-center bg-no-repeat bg-[url("../../public/infinity-studio/brand.svg")] rounded-xl pt-[35px] lg:pt-0 relative'>
                        <div className="grid grid-cols-12">
                            ...
                            <div className='col-span-12 lg:col-span-5 flex justify-center'>
                                <div className='lg:absolute lg:bottom-[-9%] w-[400px] lg:w-[490px] xl:w-[530px] h-full lg:h-auto mb-0 flex items-end bottom-0  right-0 '>
