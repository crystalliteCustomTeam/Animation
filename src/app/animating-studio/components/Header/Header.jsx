                        ...
                        <div className="col-span-12 xl:col-span-8 xl:block hidden">
                            <div className="nav_lists">
                                <ul className='flex justify-end items-center gap-x-4 xl:gap-x-7'>
                                    ...
                                    <li>
                                        <a href='javascript:$zopim.livechat.window.show();' className='flex items-center justify-center text-[15px] text-white font-[700] font-sans bg-transparent ml-[10px] py-[10px] px-[8px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-xl duration-700 transition-all hover:duration-700 hover:transition-all border border-white'>
