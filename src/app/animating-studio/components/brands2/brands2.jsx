...
const Brands = ({ content }) => {
    ...
    return (
        <>
            <section className='pt-0 md:pt[50px] lg:pt-[90px] lg:relative px-4 xl:px-0 '>
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto">
                    <div className='px-10 bg-cover bg-center bg-no-repeat bg-[url("../../public/infinity-studio/brand.svg")] rounded-xl pt-[35px] lg:pt-0'>
