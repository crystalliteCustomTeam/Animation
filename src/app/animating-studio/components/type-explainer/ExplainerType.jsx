...
const ExplainerType = () => {
    ...
    return (
        <>
            <section className='pt-[40px] pb-0 md:py-[40px] lg:py-[70px]'>
                    ...
                    <Slider {...testiSlider} className="typeSlider">
                        <div className='p-3'>
                            <div className="card rounded-[15px] h-full bg-[#FFCC00] shadow-md pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center">
                                    <h3 className='text-black text-[18px] md:text-[22px] border-b-[1px] border-[#A70A0E] font-bold poppins pt-[10px] mb-[10px] leading-[23px] md:leading-[33px] '>board Animation Video</h3>
                                    ...
                                    <div className='flex justify-end w-full mt-3'>
                                        <button onClick={popupHandle} className='flex items-center text-[15px] text-[#000] font-[500] poppins py-[6px] px-[15px] rounded-[8px] bg-[#A70A0E] text-[#fff] tracking-[.3px] leading-[20px] duration-700 transition-all '>
                        ...
                        <div className='p-3'>
                            <div className="card rounded-[15px] h-full bg-[#A70A0E] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center">
                                    <h3 className='text-[#fff] text-[18px] md:text-[22px] border-b-[1px] border-[#FFCC00] font-bold poppins pt-[10px] md:pt-[30px] lg:pt-[20px] mb-[10px] leading-[23px] md:leading-[33px] '> <span className='text-[#FFCC00]'>Motion</span> Graphics</h3>
                                    ...
                                    <div className='flex justify-end w-full mt-3'>
                                        <button onClick={popupHandle} className='flex items-center text-[15px] text-[#000] font-[500] poppins py-[6px] px-[15px] rounded-[8px] bg-[#FFCC00] text-[#A70A0E] tracking-[.3px] leading-[20px] duration-700 transition-all '>
                                            Get Started <span className='ps-2'><HiOutlineArrowLongRight size={28} /></span>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className='p-3'>
                            <div className="card rounded-[15px] h-full bg-[#003262] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center">
                                    <h3 className='text-[#fff] text-[18px] md:text-[22px] border-b-[1px] border-indigo-500 font-bold poppins pt-[10px] md:pt-[30px] lg:pt-[20px] mb-[10px] leading-[23px] md:leading-[33px] '><span className='text-[#FFCC00]'>2D Character</span> Animation Videos</h3>
                                    ...
                                    <div className='flex justify-end w-full mt-3'>
                                        <button onClick={popupHandle} className='flex items-center text-[15px] text-[#000] font-[500] poppins py-[6px] px-[15px] rounded-[8px] bg-[#FFCC00] text-[#000] tracking-[.3px] leading-[20px] duration-700 transition-all '>
                                            Get Started <span className='ps-2'><HiOutlineArrowLongRight size={28} /></span>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className='p-3'>
                            <div className="card rounded-[15px] h-full bg-[#FFCC00] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center">
                                    <h3 className='text-black text-[18px] md:text-[22px] border-b-[1px] border-[#A70A0E] font-bold poppins pt-[10px] mb-[10px] md:pt-[30px] lg:pt-[20px] leading-[23px] md:leading-[33px] '>3D Animation Video</h3>
                        ...
                        <div className='p-3'>
                            <div className="card rounded-[15px] h-full bg-[#A70A0E] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center">
                                    <h3 className='text-[#fff] text-[18px] md:text-[22px] border-b-[1px] border-[#FFCC00] font-bold poppins pt-[10px] md:pt-[30px] lg:pt-[20px] mb-[10px] leading-[23px] md:leading-[33px] '><span className='text-[#FFCC00]'>Screencast</span> Videos</h3>
                        ...
                        <div className='p-3'>
                            <div className="card rounded-[15px] h-full bg-[#003262] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center">
                                    <h3 className='text-[#fff] text-[18px] md:text-[22px] border-b-[1px] border-indigo-500 font-bold poppins pt-[10px] md:pt-[30px] lg:pt-[20px] mb-[10px] leading-[23px] md:leading-[33px] '><span className='text-[#FFCC00]'>Typography</span> Videos</h3>
