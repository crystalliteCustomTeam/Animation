    ...
    return (
        <section className='pt-[40px] pb-0 md:pb-[20px] md:pt-[80px] '>
            <div className="px-4 sm:px-8">
                ...
                <div className="mt-[25px] md:mx-[25px] relative">
                    <Slider {...testiSlider} className="newvideoSlider" ref={slider => {
                        sliderRef = slider;
                    }}>
                        {testiContentNew2.map((testimonial, index) => (
                            <Fancybox options={{ Carousel: { infinite: false } }} key={index}>
                                <div className=" h-full group mb-8 mx-2">
                                    <div className='flex border rounded-[25px] mx-4 ps-[15px] pe-[10px] md:px-[15px] md:py-[15px]' onMouseEnter={handleVideoPlay} onMouseLeave={handleVideoPause}>
                                        {testimonial.video ? (
