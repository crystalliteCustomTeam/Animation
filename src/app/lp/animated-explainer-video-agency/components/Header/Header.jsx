                        ...
                        <div className="col-span-12 lg:col-span-9 lg:block hidden">
                            <div className="nav_lists">
                                <ul className='flex items-center justify-end gap-x-4'>
                                    ...
                                    <li>
                                        <a href="javascript:void(Tawk_API.toggle())" className='flex items-center text-white font-normal poppins bg-[#ff2d4c2f] border-2 xl:ml-[10px] h-[40px] xl:h-[45px] px-[8px] xl:px-[12px] tracking-[.3px] rounded-[5px] shadow-xl duration-700 transition-all hover:bg-[#FF2D4B] hover:duration-700 hover:transition-all text-[14px] lg:text-[13px] xl:text-[14px]'>
