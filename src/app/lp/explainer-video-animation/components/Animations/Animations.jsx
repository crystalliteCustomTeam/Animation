                        ...
                        <div className="col-span-12 lg:col-span-6">
                            ...
                            <div className='flex items-center gap-4'>
                                ...
                                <div className="btn mt-6 w-[180px]">
                                    <a className="text-[14px] xl:text-[16px] text-black poppins font-bold leading-[25px] bg-white rounded-[5px] max-width h-[44px] px-[10px] md:px-[20px] poppins flex items-center justify-center" href="javascript:parent.LC_API.open_chat_window();">
