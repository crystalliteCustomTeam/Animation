                        ...
                        {isBranImage ?
                            <div className="col-span-12 lg:col-span-7">
                                ...
                                <div className='flex flex-col md:flex-row items-start md:items-center justify-start gap-4 mt-6'>
                                    ...
                                    <div className="btn w-max">
                                        <a className="text-[14px] lg:text-[12px] xl:text-[14px] font-bold text-white bg-black rounded-[5px] px-4 xl:px-10 max-width h-[40px] xl:h-[45px] poppins flex items-center justify-center gap-2" href="javascript:parent.LC_API.open_chat_window();">
                            ...
                            <div className="col-span-12 lg:col-span-6">
                                ...
                                <div className='flex flex-col md:flex-row items-start md:items-center justify-start gap-4 mt-6'>
                                    <div className="btn w-max">
                                        <a href="javascript:parent.LC_API.open_chat_window();" className="text-[14px] lg:text-[12px] xl:text-[14px] font-bold text-white bg-black rounded-[5px] px-4 xl:px-10 max-width h-[40px] xl:h-[45px] poppins flex items-center justify-center">Let’s Animate Your Idea</a>
                                    </div>
                                    <div className='btn w-max'>
                                        <a href="tel:833-666-6689" className='flex items-center gap-2 max-width h-[40px] xl:h-[45px] text-[14px] lg:text-[12px] xl:text-[14px] poppins font-bold text-white'>
                                            <Image src={flag} alt='UK' className='object-contain' />
