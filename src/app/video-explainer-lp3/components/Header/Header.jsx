...
const HeaderLP = () => {
    ...
    return (
        <>
            <header className={`fixed left-0 top-0 py-6 z-50 w-full ${isScrolled ? 'bg-[#542f30fa] shadow-lg' : 'bg-transparent'} ${isScrollDown ? 'pt-3 md:pt-6' : ''}`}>
                        ...
                        <div className="col-span-12 lg:col-span-8 lg:block hidden">
                            <div className="nav_lists">
                                <ul className='flex items-center justify-end gap-x-2 xl:gap-x-7'>
                                    ...
                                    <li>
                                        <div className='flex items-center text-[15px] text-white font-[700] font-sans bg-black ml-[10px] py-[10px] px-[15px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-xl duration-700 transition-all hover:bg-[#fb0d1c] hover:duration-700 hover:transition-all'>
                                            <Image src={Chat} alt='UK' className='object-contain grayscale-[1] brightness-[100]' />
                                            <a href="javascript:parent.LC_API.open_chat_window();" className='text-[15px] text-white px-[8px] font-[700] font-sans'>
                                                Live Chat
                                            </a>
                                        </div>
                                    </li>
