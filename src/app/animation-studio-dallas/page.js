...
//==== Hero Images
import BannerImg from "media/location-page/dallas.png"
        ...
        {isMobile
          ...
          : showDesktopComponents && (
              <>
                ...
                <HeroBottom />
                <Speedometer
                  title='<span className="text-primary-100">Best</span> Video Animation <br /> Company <span className="text-primary-100"> in Dallas <br /> </span>  With Diverse Services'
