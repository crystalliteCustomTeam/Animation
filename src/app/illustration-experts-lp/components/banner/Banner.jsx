                    ...
                    <div className="grid grid-cols-12 gap-y-12 justify-content-center">
                        <div className="col-span-12 lg:col-span-6 content-center px-[15px]">
                            ...
                            <div className="flex gap-4 md:gap-6">
                                ...
                                <div className="btn">
                                    <button onClick={popupHandle} className='flex items-center text-[16px] text-black hover:text-white font-[700] montserrat bg-[#ffffff] hover:bg-[#fa690c] py-[12px] px-[20px] md:px-[35px] tracking-[.3px] rounded-full leading-[20px] shadow-2xl border-[1.5px] border-[#000000] hover:border-[#fa690c]'>
                                        Live Chat
                                    </button>
                                </div>
