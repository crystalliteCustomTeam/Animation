...
const LocationPage = () => {
  ...
  const hero = {
    ...
    para: "Welcome to our animation studios NYC where creativity meets technology. We specialize in delivering world-class animation services tailored to your unique needs. Whether you're looking for 2D animation, 3D animation, or engaging Explainer videos, our team of New York animation experts ensures your brand's story is told with creativity and precision.",
    btnBg: "bg-prime",
    banImg: true,
    BannerImg: BannerImg,
    topLeft: topLeft,
  ...
  const Desc5 = {
    title: (
      <>
        New York City Animation Studio{" "}
        <span className="text-primary-100">
