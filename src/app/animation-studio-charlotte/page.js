...
//==== Hero Images
import BannerImg from "media/location-page/charlotte.png"
...
const LocationPage = () => {
  ...
  const hero = {
    ...
    para: <>
    Elevate your brand with captivating visuals crafted by one of the Charlotte top animation studios. Whether you’re looking for innovative storytelling or dynamic 3D animations, our team combines creativity with advanced technology to deliver solutions that resonate with your audience. As a trusted animation studio Charlotte, we specialize in turning your ideas into visually striking narratives that leave a lasting impression.
    <br/>
    <br/>
  ...
  const Desc1 = {
    ...
    para: <>
    In a competitive market, your brand deserves a visual edge. As a leading animation company Charlotte, we pride ourselves on delivering high-quality animations tailored to your vision. Our team combines creativity, precision, and cutting-edge technology to produce animations that capture attention and drive results. From small businesses to large enterprises, our client-centric approach ensures satisfaction at every step.
    <br/>
    <br/>
  ...
  const Desc2 = {
    title: (
      <>
        ...
        <span className="text-[#FF2D4A]"> Charlotte’s Competitive Market</span>
      </>
    ),
    para: <>
    In today’s digital-first landscape, animation is one of the most effective tools for engaging audiences. Businesses using video animations see a 49% faster revenue growth compared to those relying on static content. By choosing our animation studios in Charlotte NC, you gain access to visuals that elevate brand awareness, improve audience engagement, and drive conversions.
    <br/>
    <br/>
Animation isn’t just a trend—it’s the future of marketing.
  ...
  const Desc3 = {
    ...
    para: <>
    Social media is all about capturing attention quickly—and nothing does that better than animation. Whether it’s a short promotional clip for Instagram or an animated infographic for LinkedIn, we specialize in creating social media-ready animations that boost engagement and drive shares.
    <br/>
    <br/>
Your online presence deserves visuals that stand out. Let’s make it happen.
  ...
  const Desc5 = {
    title: (
      <>
        Charlotte Animation Studio{" "}
        <span className="text-primary-100">
          With Professional Animation Production
        </span>
      </>
    ),
    para: "Animation offers a unique blend of creativity and effectiveness, making it an ideal communication tool for the modern age. It simplifies complex information, captivates audiences, and leaves a lasting impression. From explainer videos to product demos, animation is the most engaging way to tell your story.",
    bannerLeft:
  ...
  const portfolio = {
    ...
    para: (
      <>
        Discover how we’ve helped businesses like yours make an impact with animation.
      </>
    ),
  ...
  //=====Looking Fold=====//
  const paraArray = [
    `Choosing the right animation partner is critical to your success. As one of the Charlotte top animation studios, we bring creativity, expertise, and a client-first approach to every project. Whether you’re a startup or a well-established business, we tailor our services to fit your unique needs, ensuring your project achieves its full potential.`,
  ]
        ...
        {isMobile
          ...
          : showDesktopComponents && (
              <>
                ...
                <HeroBottom />
                <Speedometer
                  title='<span className="text-primary-100">Best</span> Video Animation <br /> Company <span className="text-primary-100"> in Charlotte <br /> </span>  With Diverse Services'
