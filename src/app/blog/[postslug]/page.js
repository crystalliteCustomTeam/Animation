                            ...
                            <div className='grid grid-cols-12 content-center lg:gap-16'>
                                <div className='col-span-12 lg:col-span-6 flex flex-col items-start py-[35px]'>
                                    ...
                                    {postData.blogDescription.topDescription && (
                                        <>
                                            <p dangerouslySetInnerHTML={{ __html: postData.blogDescription.topDescription }} className="text-[15px] xl:text-[16px] font-normal font-sans leading-normal tracking-wider text-justify pt-3 pb-1 text-white text-opacity-90 sm:text-[17px] border-b-2 border-gray-500">
                                            </p>
                                        </>
                                    )}
