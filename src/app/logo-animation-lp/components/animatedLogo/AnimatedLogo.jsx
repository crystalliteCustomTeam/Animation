            ...
            <section className='pt-[30px] pb-[60px]'>
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                        <div>
                            <div className="logoCardShadow border-[5px] border-[#a06b43] p-[20px] duration-700 ease-in-out hover:duration-700">
                        ...
                        <div>
                            <div className="logoCardShadow border-[5px] border-[#b6b8b9] p-[20px] duration-700 ease-in-out hover:duration-700">
                                <div className="txt text-center">
                        ...
                        <div>
                            <div className="logoCardShadow border-[5px] border-[#b9a77c] p-[20px] duration-700 ease-in-out hover:duration-700">
                                <div className="txt text-center">
                        ...
                        <div>
                            <div className="logoCardShadow border-[5px] border-[#272727] p-[20px] duration-700 ease-in-out hover:duration-700">
                                <div className="txt text-center">
