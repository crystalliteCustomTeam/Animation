        ...
        <>
            ...
            <div className="footer_bottom bg-[#F5F5F5] text-center">
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto border-t border-[#888888] py-[10px]">
                    <span className='text-[14px] pb-[12px] text-[#333] montserrat text-center '>© 2024 - <p className='text-[14px] lg:text-[16px] poppins text-center inline'> - All Rights Reserved By Dreamweave Media Inc </p> </span>
                </div>
            </div>
        </>
    )
