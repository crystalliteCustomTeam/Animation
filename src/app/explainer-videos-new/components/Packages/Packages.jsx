                ...
                <div className="max-w-7xl mx-auto ">
                    ...
                    <div className="grid grid-cols-12 gap-4 lg:gap-9">
                        <div className="col-span-4 group">
                            <div className="card relative border-[#ccc] border rounded-[15px] pt-[25px] mb-[1.5rem] group-hover:bg-gradient-to-t from-[#5c1dff] to-[#1f0c4a] duration-700 ease-in-out group-hover:duration-700">
                                <div className="header border-b-2 border-[#ccc] mb-[20px] pb-[20px] mx-[25px]">
                                    <h2 className='text-[#333] text-[35px] leading-[40px] font-[700] poppins group-hover:text-white'>$165 <br />
                                        Basic Videos</h2>
                                ...
                                <div className="card_main relative mx-[10px] group-hover:mx-[8px] group-hover:duration-700 duration-700">
                                    <div className="pr-[10px] pl-[25px] bg-[#eee] duration-700 ease-in-out pt-[20px] group-hover:bg-white">
                                        <ul className='max-h-[271px] overflow-hidden group-hover:overflow-y-scroll overflow-x-hidden packagesScroll pr-[0] group-hover:pr-[35px] group-hover:duration-700 duration-700 ease-in-out pb-[20px]'>
                                            <li className='text-[#171b41] text-[18px] mb-[10px] font-[400] poppins flex'>
                                ...
                                <div className="flex items-center justify-between mt-[35px] mb-[30px] px-[40px]">
                                    <div className="btnOne">
                                        <Link href="javascript:;" className='group-hover:bg-white group-hover:text-[#1c214e] bg-[#1c214e] duration-700 ease-in-out group-hover:duration-700 text-white text-[18px] py-[10px] px-[40px] poppins cursor-pointer rounded-[30px] font-[700]'>
                                            Order Now
                                        </Link>
                                    </div>
                                    <div className="livechat">
                                        <Link href="javascript:;" className='text-[20px] text-[#333] group-hover:text-white duration-700 ease-in-out group-hover:duration-700  leading-[1.2] font-[700] poppins'>
                                            <span className='text-[#1c214e] group-hover:text-white duration-700 ease-in-out group-hover:duration-700  text-[14px] font-[300] font-sans flex items-center'>
                                                Click here to
                                ...
                                <div className="card_bottom bg-[#eee] text-center py-[6px] rounded-b-[14px]">
                                    <Link href="tel:;" className='text-[#333] text-[14px] font-[400] poppins'>
                        ...
                        <div className="col-span-4 group">
                            <div className="card relative border-[#ccc] border rounded-[15px] pt-[25px] mb-[1.5rem] group-hover:bg-gradient-to-t from-[#5c1dff] to-[#1f0c4a] duration-700 ease-in-out group-hover:duration-700">
                                <div className="header border-b-2 border-[#ccc] mb-[20px] pb-[20px] mx-[25px]">
                                    <h2 className='text-[#333] text-[35px] leading-[40px] font-[700] poppins group-hover:text-white'>$499 <br />
                                        Premium Videos</h2>
