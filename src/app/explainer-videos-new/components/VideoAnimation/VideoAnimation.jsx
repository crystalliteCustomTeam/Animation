                            ...
                            <div className="md:ml-[43px]">
                                ...
                                <div className="flex items-center gap-x-4">
                                    ...
                                    <div className="btn1 group">
                                        <a href="javascript:parent.LC_API.open_chat_window();" className='text-[14px] md:text-[18px] rounded-[30px] text-[#282828] font-[800] font-sans group-hover:bg-[#f36e16] group-hover:duration-700 duration-700 ease-in-out group-hover:text-white py-[14px] px-[35px] group-hover:px-[35px] flex items-center relative'>
                                            Live Chat
