...
//==== Hero Images
import BannerImg from "media/location-page/phoneix.png"
...
const LocationPage = () => {
  ...
  const hero = {
    ...
    para: "Capturing attention now is more challenging than ever. Businesses, brands, and creatives need more than static visuals—they need motion, engagement, and storytelling that connects. That’s where Phoenix Animation Studios comes in. We are an industry-leading animation studio in Phoenix, committed to crafting compelling visuals that elevate your brand and leave a lasting impact.",
    btnBg: "bg-prime",
    banImg: true,
    BannerImg: BannerImg,
    topLeft: topLeft,
  ...
  const Desc1 = {
    ...
    para: (
      <>
        At Phoenix Animation Studios, we understand that every project is unique
        and requires a tailored approach. Our team is dedicated to collaborating
        closely with clients to ensure that each animation reflects their vision
        and objectives. By combining innovative techniques with a deep
        understanding of storytelling, we create compelling animations that
        resonate with audiences across various platforms. Whether it's for
        marketing, education, or entertainment, our goal is to deliver
        exceptional quality that not only meets but exceeds expectations.
        Partner with us to bring your ideas to life through the art of animation
      </>
    ),
  ...
  const Desc2 = {
    title: (
      <>
        ...
        <span className="text-[#FF2D4A]"> New York's Competitive Market</span>
      </>
    ),
    para: (
      <>
        Businesses need more than static content to capture their audience’s
        attention. Animated videos offer a powerful way to explain complex
        ideas, showcase products, and engage viewers. Whether you’re looking to
        boost social media interactions or increase website dwell time, our
        Phoenix animation studio creates custom animations that drive results.
        <br />
        <br />
        Studies show that viewers retain 95% of a message when watching a video
        compared to only 10% when reading text. That’s why companies across
        industries are turning to animated content—it simplifies information,
        improves brand recall, and encourages users to take action.
        <br />
        <br />
        By partnering with Phoenix Animation Studios, you ensure your brand
        stays relevant, engaging, and ahead of the competition. Let’s create
        something that not only grabs attention but also converts.
      </>
    ),
    bannerRight:
  ...
  const Desc3 = {
    title: (
      <>
        ...
        <span className="text-primary-100">
          Video Production Company Pheonix
        </span>
      </>
    ),
    para: (
      <>
        As environmental awareness increases, the animation industry is
        embracing sustainable practices to lessen its ecological impact. At
        Phoenix Animation Studios, we are dedicated to implementing eco-friendly
        production methods. By utilizing fully digital workflows, we
        significantly reduce paper consumption and waste, thereby contributing
        to environmental conservation. We employ energy-efficient hardware and
        optimize rendering processes to minimize power usage without
        compromising quality. Additionally, we collaborate with like-minded
        vendors and clients to prioritize sustainability throughout the
        production cycle. Our commitment to sustainable animation practices
        reflects our responsibility to the environment and aligns with our
        clients' growing preference for eco-conscious partners.
      </>
    ),
    bannerLeft:
  ...
  const Desc4 = {
    title: (
      <>
        Phoenix’s Premier Animation Studio{" "}
        <span className="text-primary-100"> With Custom Animation Services</span>
      </>
    ),
    para: (
      <>
        Artificial Intelligence is transforming animation by streamlining
        ...
        and opens new avenues for creative expression.
      </>
    ),
    bannerRight:
  ...
  const Desc5 = {
    ...
    para: (
      <>
        Combining the charm of 2D art with the depth of 3D modeling, hybrid
        animations offer a unique aesthetic that captivates audiences. This
        approach provides flexibility in visual storytelling, enabling the
        creation of rich, immersive experiences that stand out in a crowded
        media landscape
      </>
    ),
    bannerLeft:
  ...
  const why2 = {
    ...
    para: "<p>A successful animation project requires more than just creativity—it demands precision, organization, and seamless execution. That’s why Phoenix Animation Studios follows a structured process that ensures timely delivery and high-quality results.</p><p>Being based in Phoenix, we offer a local advantage, allowing for in-person collaboration, real-time updates, and a flexible workflow tailored to your needs. Whether you’re launching a marketing campaign, developing an e-learning module, or creating a product animation, we work closely with you to ensure your vision is executed flawlessly.</p><p>From brainstorming to final delivery, our goal is to make the process smooth, efficient, and stress-free. Let’s work together and bring your ideas to life.</p>",
    bannerLeft:
  ...
  const portfolio = {
    ...
    para: (
      <>
        Our portfolio showcases the depth of our work across industries,
        including corporate animations, product demos, architectural
        visualizations, and cinematic animations. Whether you’re in real estate,
        healthcare, entertainment, or education, our animation studios Phoenix
        team has helped brands like yours create compelling visuals that stand
        out.
        <br />
        <br />
        Explore our projects and see how we can elevate your brand with
  ...
  const paraArray = [
    [
      "Standing out in today’s crowded digital space requires more than just good animation. It demands storytelling, emotion, and technical excellence. Our Phoenix animation studio combines these elements to create animations that captivate audiences and drive action.",
    ],
    [
      "With years of industry experience, our team delivers custom animation solutions tailored to your goals. Whether you need an explainer video for a product launch or a fully immersive 3D animation for a film project, we ensure high-quality visuals that make an impact.",
    ],
  ]
        ...
        {isMobile
          ...
          : showDesktopComponents && (
              <>
                ...
                <HeroBottom />
                <Speedometer
                  title='<span className="text-primary-100">Best</span> Video Animation <br /> Company <span className="text-primary-100"> in Pheonix <br /> </span>  With Diverse Services'
