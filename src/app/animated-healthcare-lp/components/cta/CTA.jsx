    ...
    return (
        ...
        <>
            {icon ? <div dangerouslySetInnerHTML={{ __html:
                `
                    <a href=${href} class="h-[40px] xl:h-[50px] px-6 rounded-md text-[16px] xl:text-[18px] font-normal font-sans flex items-center gap-x-2 ${color} ${bg} ${hover} ${border}"> 
                ...
                :
                <a href={href} className={`${color} ${bg} ${hover} ${border} h-[40px] xl:h-[50px] px-6 rounded-md flex items-center gap-x-2`}>
