...
const LocationPage = () => {
  ...
  const Desc1 = {
    title: (
      <>
        California Animation Studio <br />{" "}
  ...
  const Desc2 = {
    title: (
      <>
        ...
        <span className="text-[#FF2D4A]"> California’s Competitive Market</span>
      </>
    ),
  ...
  const Desc3 = {
    title: (
      <>
        ...
        <span className="text-primary-100">
          Video Production Company California
        </span>
      </>
    ),
  ...
  const portfolio = {
    ...
    para: (
      <>
        ...
        expertise in California animation.
      </>
    ),
  ...
  //=====Looking Fold=====//
  const paraArray = [
    `Choosing the right animation studio is a pivotal step toward ensuring your project’s success. At Infinity Animations, we merge unmatched creativity, advanced technical expertise, and a commitment to understanding your unique goals. With decades of experience, our team specializes in crafting animations that captivate audiences, communicate powerful messages, and deliver measurable results. Whether you're seeking dynamic advertising visuals or immersive 3D animations, we provide solutions that inspire trust and elevate your brand to new heights. Let us bring your vision to life with animations that truly make an impact.`,
  ]
        ...
        {isMobile
          ...
          : showDesktopComponents && (
              <>
                ...
                <HeroBottom />
                <Speedometer
                  title='<span className="text-primary-100">Best</span> Video Animation <br /> Company <span className="text-primary-100"> in California  <br /> </span>  With Diverse Services'
