                            ...
                            <Fancybox options={{
                                ...
                                <div>
                                    <Link href="https://player.vimeo.com/progressive_redirect/playback/947422905/rendition/1080p/file.mp4?loc=external&signature=f56596bad42e22dfbb5dcf417293fe4f92f3fc7e84a9464be5c8f07f903eaa05" datafancybox="gallery">
                                        ...
                                        <div className="absolute bottom-[2px] left-0 w-full h-full flex items-start justify-end flex-col bg-gradient-to-t from-black/80 to-transparent rounded-[20px] px-[20px] pb-[20px] sm:px-[40px] sm:pb-[40px]">
                                        <h3 className="text-white text-[18px] md:text-[26px] font-sans font-[400] md:pb-2 ">3D Animation Services</h3>
                                        <p className='text-white text-[13px] sm:text-[17px] font-sans leading-[19px] lg:w-11/12 overflow-y-scroll h-[35px]'>Our 3D animation services are not just visuals; they're an immersive experience that propels your brand into the future. Our skilled team of 3D artists and visionaries transform concepts into living, breathing narratives that captivate audiences.</p>
                                            <div className="btn w-full flex items-center justify-end">
                                                <a href='javascript:$zopim.livechat.window.show();' className='mt-4 text-[14px] xl:text-[16px] text-white font-semibold poppins ml-[10px] py-[8px] sm:py-[12px]  px-[10px] xl:px-[20px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-3xl duration-700 transition-all bg-[#FF2D4B] hover:duration-700 hover:transition-all flex items-center gap-x-3'>Make an Animation
                            ...
                            <Fancybox options={{
                                ...
                                <div>
                                    <Link href="https://player.vimeo.com/progressive_redirect/playback/957421481/rendition/1080p/file.mp4?loc=external&signature=2200951cfd824565a3f569c81e997b1f7c5ad0a443debd2bc4d73ff7a3b0f27b" datafancybox="gallery">
                                        ...
                                        <div className="absolute bottom-[2px] left-0 w-full h-full flex items-start justify-end flex-col bg-gradient-to-t from-black/95 via-black/65 to-transparent rounded-[20px] px-[20px] pb-[20px] sm:px-[40px] sm:pb-[40px]">
                                            <h3 className="text-white text-[18px] md:text-[26px] font-sans font-[400] md:pb-2">Cel Animation Services</h3>
                                            <p className='text-white text-[13px] sm:text-[17px] font-sans leading-[19px] lg:w-11/12 overflow-y-scroll h-[35px]'>With Cel Animation, we seamlessly merge traditional hand-drawn Cel animation techniques with cutting-edge digital elements. This dynamic fusion results in visuals that not only pay homage to the timeless charm of Cel animation but also push the boundaries of innovation.</p>
                                            <div className="btn w-full flex items-center justify-end">
                                                <a href='javascript:$zopim.livechat.window.show();' className='mt-4 text-[14px] xl:text-[16px] text-white font-semibold poppins ml-[10px] py-[8px] sm:py-[12px]  px-[10px] xl:px-[20px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-3xl duration-700 transition-all bg-[#FF2D4B] hover:duration-700 hover:transition-all flex items-center gap-x-3'>Make an Animation
                                                    <Image src={Arrow} className='w-[10px] h-[10px] object-contain' alt='Arrow' width={8} height={9} />
                                                </a>
                            ...
                            <Fancybox options={{
                                ...
                                <div>
                                    <Link href="https://player.vimeo.com/progressive_redirect/playback/923043536/rendition/1080p/file.mp4?loc=external&signature=65ba4de21993e2ab518a0dbad0e015b2bd960e70967b63241c8509cc1f8c5390" datafancybox="gallery">
                                        ...
                                        <div className="absolute bottom-[2px] left-0 w-full h-full flex items-start justify-end flex-col bg-gradient-to-t from-black/95 via-black/65 to-transparent rounded-[20px] px-[20px] pb-[20px] sm:px-[40px] sm:pb-[40px]">
                                            <h3 className="text-white text-[18px] md:text-[26px] font-sans font-[400] md:pb-2">Architectural Visualization Services</h3>
                                            <p className='text-white text-[13px] sm:text-[17px] font-sans leading-[19px] lg:w-11/12 overflow-y-scroll h-[35px]'>At the intersection of innovation and aesthetics, our Architectural Visualization Services go beyond rendering structures; they create visual stories that resonate. Whether it's a residential project, commercial space, or urban development.</p>
                                            <div className="btn w-full flex items-center justify-end">
                                                <a href='javascript:$zopim.livechat.window.show();' className='mt-4 text-[14px] xl:text-[16px] text-white font-semibold poppins ml-[10px] py-[8px] sm:py-[12px]  px-[10px] xl:px-[20px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-3xl duration-700 transition-all bg-[#FF2D4B] hover:duration-700 hover:transition-all flex items-center gap-x-3'>Make an Animation
                                                    <Image src={Arrow} className='w-[10px] h-[10px] object-contain' alt='Arrow' width={8} height={9} />
                                                </a>
                            ...
                            <Fancybox options={{
                                ...
                                <div>
                                    <Link
                                        ...
                                        <div className="absolute bottom-[2px] left-0 w-full h-full flex items-start justify-end flex-col bg-gradient-to-t from-black/95 via-black/65 to-transparent rounded-[20px] px-[20px] pb-[20px] sm:px-[40px] sm:pb-[40px]">
                                            <h3 className="text-white text-[18px] md:text-[26px] font-sans font-[400] md:pb-2">Hybrid Animation Service</h3>
                                            <p className='text-white text-[13px] sm:text-[17px] font-sans leading-[19px] lg:w-11/12 overflow-y-scroll h-[35px]'>Oborderur 3D animation services are not just visuals; they're an immersive experience that propels your brand into the future. Our skilled team of 3D artists and visionaries transform concepts into living, breathing narratives that captivate audiences.</p>
                                            <div className="btn w-full flex items-center justify-end">
                                                <a href='javascript:$zopim.livechat.window.show();' className='mt-4 text-[14px] xl:text-[16px] text-white font-semibold poppins ml-[10px] py-[8px] sm:py-[12px]  px-[10px] xl:px-[20px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-3xl duration-700 transition-all bg-[#FF2D4B] hover:duration-700 hover:transition-all flex items-center gap-x-3'>Make an Animation
                                                    <Image src={Arrow} className='w-[10px] h-[10px] object-contain' alt='Arrow' width={8} height={9} />
                                                </a>
                            ...
                            <Fancybox options={{
                                ...
                                <div>
                                    <Link
                                        ...
                                        <div className="absolute bottom-[2px] left-0 w-full h-full flex items-start justify-end flex-col bg-gradient-to-t from-black/95 via-black/65 to-transparent rounded-[20px] px-[20px] pb-[20px] sm:px-[40px] sm:pb-[40px]">
                                            <h3 className="text-white text-[16px] md:text-[26px] font-sans font-[400] md:pb-2">2D Animation Service</h3>
                                            <p className='text-white text-[13px] sm:text-[17px] font-sans leading-[19px] lg:w-11/12 overflow-y-scroll h-[35px]'>2D animation involves creating movement in a two-dimensional space, offering a timeless and versatile visual experience. Our service leverages the simplicity and charm of hand-drawn elements to craft engaging and visually stunning animations. This approach allows for clear and effective communication, perfect for explainer videos, marketing campaigns, and educational content. By focusing on high-quality, captivating animations, we ensure that your message resonates with your audience and leaves a lasting impression.</p>
                                            <div className="btn w-full flex items-center justify-end">
                                                <a href='javascript:$zopim.livechat.window.show();' className='mt-4 text-[14px] xl:text-[16px] text-white font-semibold poppins ml-[10px] py-[8px] sm:py-[12px]  px-[10px] xl:px-[20px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-3xl duration-700 transition-all bg-[#FF2D4B] hover:duration-700 hover:transition-all flex items-center gap-x-3'>Make an Animation
                                                    <Image src={Arrow} className='w-[10px] h-[10px] object-contain' alt='Arrow' width={8} height={9} />
                                                </a>
