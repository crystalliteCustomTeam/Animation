        ...
        <>
            ...
            <div className="copyright py-[20px]">
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto relative">
                    <p className='text-[14px] pb-[12px] text-[#333] montserrat text-center'>© 2024 - <p className='text-[14px] lg:text-[16px] text-white poppins text-center inline'> - All Rights Reserved By<Link href="https://bhaooinc.com/">Bhaoo Inc</Link></p> <Link target="_blank" className="no-underline" href="https://bhaooinc.com/">Bhaoo Inc</Link></p>
