        ...
        <>
            ...
            <div className="copyright py-[20px]">
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto relative">
                    <p className='text-[14px] pb-[12px] text-[#333] montserrat text-center'>© 2024 - <p className='text-[14px] lg:text-[16px] text-white poppins text-center'>© Copyright 2024 infinity Animations - All Rights Reserved By<Link href="https://mini-investments.net/">Mini Investments</Link></p> <Link target="_blank" className="no-underline" href="https://mini-investments.net/">Mini Investments</Link></p>
