                ...
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-12 lg:col-span-6">
                        <div className="image relative lg:block hidden">
                            <Image src={BannerImage} alt='Small Banner Image' className='absolute top-[-100px] xl:top-[-220px] right-0 group-hover:top-[-70px] xl:group-hover:top-[-140px] duration-700 ease-in-out group-hover:duration-700' />
                        </div>
                    </div>
                </div>
            </div>
