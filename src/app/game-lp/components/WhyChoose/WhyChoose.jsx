                    ...
                    {chooseContent.map((content, index) => (
                        <div key={index} className="group">
                            <div className='border border-[#3D3D3D] px-4 md:px-6 py-5 group-hover:bg-white group-hover:duration-1000 ease-in-out duration-1000'>
                                ...
                                <div className="btn">
                                    <a href="javascript:parent.LC_API.open_chat_window();" className='text-white text-[16px] font-medium poppins w-[190px] h-[50px] flex items-center justify-center relative z-10'>
