                    ...
                    {chooseContent.map((content, index) => (
                        <div key={index} className="group">
                            <div className='border border-[#3D3D3D] px-4 md:px-6 py-5 group-hover:bg-white group-hover:duration-1000 ease-in-out duration-1000'>
                                ...
                                <p className='text-[14px] md:text-[16px] leading-[24px] md:leading-[28px] font-normal text-white group-hover:text-black group-hover:duration-1000 ease-in-out duration-1000 poppins md:pr-4 pt-2 md:pt-3 pb-4 md:pb-6'>{content.desc}</p>
                                <div className="btn">
