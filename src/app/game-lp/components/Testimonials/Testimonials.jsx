...
const Testimonials = () => {
    return (
        <section className='py-[50px] xl:py-[90px] relative'>
                    ...
                    <div className="col-span-12">
                        <div className="txt text-center">
                            <h2 className='text-[30px] sm:text-[50px] lg:text-[60px] leading-[70px] sm:leading-[80px] lg:leading-[90px] font-semibold text-white poppins md:mb-3 relative w-full md:w-9/12 lg:w-8/12 xl:w-6/12 mx-auto'>
                                <Image src={HeadingParticle} alt='Heading' className='sm:block hidden absolute left-[15px] top-[50%] translate-y-[-50%]' />
                                Testimonials
                                <Image src={HeadingParticle} alt='Heading' className='sm:block hidden absolute right-[15px] top-[50%] translate-y-[-50%] rotate-180' />
                            </h2>
