...
export const PrevButton = (props) => {
    ...
    return (
        <button
            ...
            {...restProps}
        >
            <svg className={``} xmlns="http://www.w3.org/2000/svg" id="Group_54992" data-name="Group 54992" width="58.1" height="31.046" viewBox="0 0 58.1 31.046">
...
export const NextButton = (props) => {
    ...
    return (
        <button
            ...
            {...restProps}
        >
            <svg className={` rotate-180`} xmlns="http://www.w3.org/2000/svg" id="Group_54992" data-name="Group 54992" width="58.1" height="31.046" viewBox="0 0 58.1 31.046">
                <path id="Path_126740" data-name="Path 126740" d="M2448.527,3848.23l2.68-2.68-12.843-12.843,12.843-12.843-2.68-2.68L2433,3832.706Z" transform="translate(-2433.003 -3817.183)" fill="#fff" />
                <path id="Path_126741" data-name="Path 126741" d="M2370.722,3842.346h55.419v-3.791h-55.419Z" transform="translate(-2368.041 -3824.927)" fill="#fff" />
            </svg>
            {children}
