...
const Portfolio = () => {
    ...
    return (
        <section className='pt-[0px] pb-[50px] lg:py-[90px]'>
            <div className="grid grid-cols-12">
                <div className="col-span-12">
                    <div className="content text-center px-4 md:px-0">
                        <h2 className='text-[30px] sm:text-[50px] lg:text-[60px] leading-[70px] sm:leading-[80px] lg:leading-[90px] font-semibold text-white poppins md:mb-3 relative w-full md:w-8/12 lg:w-7/12 xl:w-5/12 mx-auto'>
                            <Image src={HeadingParticle} alt='Heading' className='sm:block hidden absolute left-[20px] top-[50%] translate-y-[-50%]' />
                            Our Portfolio
                            <Image src={HeadingParticle} alt='Heading' className='sm:block hidden absolute right-[20px] top-[50%] translate-y-[-50%] rotate-180' />
                        </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-y-10">
                {portfolio.map((content, index) => (
                    <div key={index}>
                        ...
                        <div className="txt py-4 px-4 border-r border-r-[#707070]">
                            <h3 className="text-white text-[16px] xl:text-[20px] 2xl:text-[24px] leading-[26px] xl:leading-[30px] 2xl:leading-[36px] font-semibold poppins lg:w-11/12 relative before:content-[''] before:absolute before:bottom-[-12px] before:left-0 before:w-full before:h-[1px] before:bg-[#707070] mb-3 sm:h-[50px] xl:h-[60px] 2xl:h-[70px] sm:text-left text-center">{content.title}</h3>
