...
const LocationPage = () => {
  ...
  const why1 = {
    ...
    para: "<p className='font-semibold text-[18px]'>According to research <span className='text-[50px] text-primary-100'>96%</span> buyers watch animated explainer videos to get the details of a product they want to buy.</p><p>People love watching videos online and animated videos especially explainers are ideal to tell about your brand as well as product's story in a creative way.</p><p>Watch Randy Biddle as he dissects how exactly an explainer video production company can help you achieve that.</p>",
    bannerLeft:
        ...
        {isMobile
          ...
          : showDesktopComponents && (
              <>
                ...
                <HeroBottom />
                <Speedometer
                  title="<span className='text-primary-100'>Best</span> Video Animation <br /> Company <span className='text-primary-100'> in Texas  <br /> </span>  With Diverse Services"
