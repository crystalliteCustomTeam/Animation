...
const LocationPage = () => {
  ...
  const hero = {
    ...
    para: (
      <>
        A great product deserves to be seen from every angle. At Infinity Animations in Folsom, we specialize in clean, powerful 3D product animation that helps you grab attention and close the deal. Whether you’re introducing a tech gadget, a tool, or a medical device, our videos are crafted to simplify features, highlight innovation, and convert interest into action. No fluff  just visuals that get it done.
      </>
    ),
    btnBg: "bg-prime",
    banImg: true,
  ...
  const Desc1 = {
    ...
    para: "Buyers scroll fast. You have seconds to impress. Our 3D product animation services are designed for quick understanding, visual appeal, and real traction. We help brands in Folsom turn CAD files, sketches, or product shots into scroll-stopping videos that show exactly what matters.",
  ...
  const Desc2 = {
    title: (
      <>
       Folsom Animation Studio With <br />{" "}
        <span className="text-[#FF2D4A]"> Expert Animation and Visual Effects
        </span>
      </>
    ),
    para: (
      <>
       You don’t have to be a big brand to look like one. Our 3D product animations are used by Folsom clients to pitch investors, run paid ads, launch Kickstarter campaigns, and scale eCommerce sales. The best part? You own every pixel ready to reuse across platforms, presentations, and promotions.
      </>
    ),
    bannerRight:
  ...
  const Desc3 = {
    ...
    para: (
      <>
        Animation isn’t just eye candy — it’s your fastest path to brand attention. We design short-form, high-impact motion content made to perform across TikTok, Instagram, YouTube, and beyond. Whether it’s a snappy product teaser or a scroll-stopping explainer, our Folsom video production team creates platform-ready animation that grabs attention, delivers your message, and drives real results. Built for speed. Designed for clicks.
      </>
    ),
    bannerLeft:
  ...
  const Desc4 = {
    ...
    para: (
      <>
        Storytelling isn’t what it used to be — and that’s a good thing. Infinity Animations Folsom builds next-gen animated content for interactive platforms like AR and VR. From virtual product walkarounds to immersive branded experiences, we help you craft animation that your audience can explore, feel, and remember. Want your next launch to actually feel different? That’s where we come in.
      </>
    ),
    bannerRight:
  ...
  const Desc5 = {
    ...
    para: (
      <>
        We work with Folsom startups, manufacturers, and service brands to create animated content that resonates. Whether you’re simplifying technical features or telling a brand story, our animations are built for clarity, impact, and brand alignment. From 3D product demos to animated promos, every frame is shaped by your goals  and built to make your message land faster and stronger.
      </>
    ),
    bannerLeft:
  ...
  const why2 = {
    ...
    para: "<p>No more confusion or feature fatigue. With 3D product animation, your audience gets a full understanding of what your product does  and why they should purchase in seconds. Whether it’s breaking down a complex mechanism or showing off sleek product design, we help buyers visualize your product in action. The result? Higher trust, faster decisions, and fewer abandoned carts.</p><p>3D animation gives your customers the clarity they need to act. Instead of imagining how your product works, they see it rotating, assembling, demonstrating. That kind of visual certainty shortens the sales cycle and builds buyer confidence instantly. Whether you’re showcasing it online, in-store, or at investor meetings, a well-crafted product animation does the heavy lifting for you.</p>",
    bannerLeft:
  ...
  const portfolio = {
    ...
    para: (
      <>
        We believe that exceptional animation speaks louder than words. Our portfolio showcases projects across various industries, demonstrating our versatility and creativity. As one of the top small animation studios in Folsom, we work closely with clients to develop animations that stand out.
      </>
    ),
  ...
  const bannerContact = {
    title: (
      <>
        ...
        <br /> In Folsom with Diverse Services
      </>
    ),
  ...
  const want = {
    ...
    wantDesc:
      "Your search for the perfect animation studio in Folsomends here. We’re dedicated to turning your ideas into dynamic, impactful visuals that inspire and engage.",
    bgPrime: true,
  }
        ...
        {isMobile
          ...
          : showDesktopComponents && (
              <>
                ...
                <HeroBottom />
                <Speedometer
                  title='<span className="text-primary-100">Best</span> Video Animation <br /> Company <span className="text-primary-100"> in Folsom <br /> </span>  With Diverse Services'
