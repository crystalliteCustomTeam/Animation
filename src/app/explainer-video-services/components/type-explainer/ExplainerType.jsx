                            ...
                            <div className="card rounded-[25px] h-full bg-[#FFCC00] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center mt-2 sm:mt-0">
                                    ...
                                    <div className='flex justify-end w-full mt-3 mb-2 sm:mb-0'>
                                        <a href="javascript:parent.LC_API.open_chat_window();" className='flex items-center text-[15px] font-[500] poppins py-[6px] px-[15px] rounded-[8px] bg-[#A70A0E] text-[#fff] tracking-[.3px] leading-[20px] duration-700 transition-all '>
                        ...
                        <div className='p-3'>
                            <div className="card rounded-[25px] h-full bg-[#A70A0E] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center mt-2 sm:mt-0">
                                    ...
                                    <div className='flex justify-end w-full mt-3 mb-2 sm:mb-0'>
                                        <a href="javascript:parent.LC_API.open_chat_window();" className='flex items-center text-[15px] font-[500] poppins py-[6px] px-[15px] rounded-[8px] bg-[#FFCC00] text-black tracking-[.3px] leading-[20px] duration-700 transition-all '>
                                            Lets Talk <span className='ps-2'><HiOutlineArrowLongRight size={28} /></span>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className='p-3'>
                            <div className="card rounded-[25px] h-full bg-[#003262] shadow-md  pb-[15px] ">
                                ...
                                <div className="content px-[25px] min-h-[200px] lg:h-full flex flex-col items-start justify-center mt-2 sm:mt-0">
                                    ...
                                    <div className='flex justify-end w-full mt-3 mb-2 sm:mb-0'>
                                        <a href="javascript:parent.LC_API.open_chat_window();" className='flex items-center text-[15px] font-[500] poppins py-[6px] px-[15px] rounded-[8px] bg-[#FFCC00] text-[#000] tracking-[.3px] leading-[20px] duration-700 transition-all '>
                                            Lets Talk <span className='ps-2'><HiOutlineArrowLongRight size={28} /></span>
                                        </a>
                                    </div>
                                </div>
