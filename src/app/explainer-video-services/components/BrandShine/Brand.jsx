                        ...
                        {isBranImage ?
                            <div className="col-span-12 lg:col-span-7">
                                ...
                                <div className='flex items-center gap-4'>
                                    <div className="btn mt-6 w-[250px]">
                                        <a href="javascript:parent.LC_API.open_chat_window();" className="text-[13px] md:text-[16px] font-semibold leading-[25px] text-white bg-black rounded-[5px] max-width h-[44px] px-[10px] md:px-[20px] poppins flex items-center justify-center">{btnTxt}</a>
                                    </div>
                            ...
                            <div className="col-span-12 lg:col-span-6">
                                ...
                                <div className="btn mt-6">
                                    <a href="javascript:parent.LC_API.open_chat_window();" className="text-[13px] md:text-[16px] font-semibold leading-[25px] text-white bg-black rounded-[5px] w-full md:w-[410px] h-[44px] poppins flex items-center justify-center">Let's Begin Your Animated Journey Together!</a>
                                </div>
                            </div>}
                        {isBranImage ?
