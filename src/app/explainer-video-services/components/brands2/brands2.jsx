                        ...
                        <div className="grid grid-cols-12">
                            <div className='col-span-12 lg:col-span-7 py-[20px] lg:py-[30px]'>
                                ...
                                <div className="flex flex-col-reverse md:flex-row items-start md:items-center justify-start gap-5 my-2 sm:mt-0">
                                    ...
                                    <div className="btn">
                                        <a href="javascript:void(Tawk_API.toggle())" className='flex items-center justify-center gap-2 text-[15px] text-white font-[600] poppins bg-transparent h-[40px] xl:h-[45px] w-max px-5 tracking-[.3px] rounded-[5px] border mr-2'>
