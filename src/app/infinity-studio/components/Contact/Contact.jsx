        ...
        <>
            ...
            <div className="copyright py-[20px] bg-black mt-1">
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto relative">
                    <p className='text-[14px] text-[#fff] poppins text-center'>© 2024 <span className='text-[14px] text-[#fff] poppins text-center inline'> - All Rights Reserved By</span> <Link target="_blank" className="no-underline" href="https://bhaooinc.com/">Bhaoo Inc</Link></p>
