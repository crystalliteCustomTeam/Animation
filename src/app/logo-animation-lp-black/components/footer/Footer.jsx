        ...
        <>
                    ...
                    <div className="grid grid-cols-1">
                        ...
                        <div className="flex flex-wrap items-center justify-center sm:justify-between gap-2 sm:gap-5 lg:w-9/12 mx-auto pt-8">
                            <div className="number">
                                <Link href="tel:833-666-6689" className='text-white font-[600] text-[14px] sm:text-[16px] poppins flex items-center gap-x-2'>
                                    <FaPhoneAlt className='text-[#9545cc] text-[18px] sm:block hidden' />
                                    <span>833-666-6689</span>
                                </Link>
                            </div>
                            <div className="email">
                                <Link href="mailto:queries@infinityanimations.com" className='text-white font-[600] text-[14px] sm:text-[16px] poppins flex items-center gap-x-2'>
            ...
            <div className="footer_bottom bg-black text-center">
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto border-t border-white py-[10px]">
                    <span className='text-[14px] pb-[12px] text-white montserrat text-center '>© 2024 - <p className='text-[14px] lg:text-[16px] text-white poppins text-center inline'> - All Rights Reserved By<Link href="https://mini-investments.net/">Mini Investments</Link></p> Mini Investments</span>
                </div>
            </div>
        </>
    )
