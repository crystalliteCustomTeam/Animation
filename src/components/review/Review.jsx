...
const Review = () => {
    return (
        <>
            <section className="flex items-center justify-center sm:pt-3 sm:pb-8 md:mb-0 lg:pb-10 mt-[100px] md:mt-[50px] lg:mt-0">
                <AutoScroll wrapperClass="mt-10 lg:mt-5 mb-10 lg:mb-0" options={{ loop: true, align: "start" }}>
                                {
                                    [icon1, icon2, icon3, icon4, icon5, icon6, icon7, icon1, icon2, icon3, icon4, icon5, icon6, icon7, icon1, icon2, icon3, icon4, icon5, icon6, icon7].map((e, i) => (
                                        <div key={i} className="shrink-0 grow-0 basis-1/6 mr-2">
