...
const Hero = ({ content }) => {
    ...
    return (
        <>
            <section className={`w-full h-[100vh] flex items-center justify-start mt-0 md:mt-10 lg:mt-0  bg-none bg-no-repeat relative overflow-hidden z-1 top-[97px] lg:top-auto mb-10 xl:mb-0`}>
