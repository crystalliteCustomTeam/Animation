...
function Description({ content }) {
  ...
  return (
    <section
      className={`w-full flex items-center justify-start py-6 md:py-12 lg:py-16 bg-none  bg-no-repeat bg-center bg-cover relative `}
    >
      <div className="container">
        <div className="grid grid-cols-12 w-full">
          {bannerLeft && (
            <div
              className={`order-last lg:order-first mt-[25px] lg:mt-0  col-span-12 lg:col-span-6 lg:w-[80%]`}
            >
              <Fancybox
                options={{
                  Carousel: {
              ...
              >
                ...
                >
                  <div
                    className={`w-full h-full overlay relative group overflow-hidden rounded-lg`}
                  >
          ...
          <div
            className={`col-span-12 lg:col-span-6 ms-auto pe-0 md:pe-5 flex flex-col justify-center relative`}
          >
            <h2
              className={`text-[#fff] text-[30px] sm:text-[40px] font-semibold font-sans leading-tight mb-5 text-start`}
            >
              {title}
            </h2>
          ...
          {bannerRight && (
            <div
              className={`col-span-12 lg:col-span-6 lg:ms-auto my-auto mt-[25px] lg:mt-0 lg:w-[80%]`}
            >
              <Fancybox
                options={{
                  Carousel: {
