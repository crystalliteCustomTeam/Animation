...
// Import Css
import styles from "./blogPortFolio.module.css"
// Import Slick Slider
                ...
                <div className="container">
                    <div className='flex items-center justify-around'>
                        <div className='w-full text-center'>
                            ...
                            <p className="w-full md:w-[70%] lg:w-[60%] mx-auto text-[14px] sm:text-[16px] font-normal font-sans leading-snug tracking-wider text-center mb-5 text-white text-opacity-90">
                                {para}
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="tabs-content pt-7 md:pt-12 hidden md:block">
                            {tabContents[activeTab] && (
                                <Fancybox options={{
                                    ...
                                    {/* <div class="grid grid-rows-6 grid-flow-col gap-4 border">
                                        <div class="row-end-5 row-span-2 border">01</div>
                                        <div class="row-start-1 row-end-7 border">03</div>
                                        <div class="row-end-5 row-span-2 border">02</div>
                                    </div> */}
