...
function BlogTestimonialNew({ content }) {
                ...
                <div className="relative z-50">
                    <div className='flex items-center justify-center py-[25px]'>
                        <div className='w-full text-center'>
                            ...
                            <p className="text-[12px] xl:text-[16px] font-sans font-normal tracking-wider line-clamp-3 text-center mb-[35px] text-white text-opacity-90">
                                {para}
                            </p>
                        </div>
                    </div>
...
export default BlogTestimonialNew;
