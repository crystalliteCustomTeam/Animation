...
//
import LocationWorld from 'media/images/locationWorld.png'
...
const Location = () => {
    ...
    return (
        <>
            <section className="bg-black pt-[50px] pb-[70px] lg:pb[50px] relative">
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 items-center'>
                            <div>
                                ...
                                <div className="hidden lg:block mt-11">
                                    <h4 className="text-[28px] font-sans font-bold text-center border-t-[1px] border-b-[1px] border-white py-1 mb-2">USA</h4>
                                ...
                                <div className="block lg:hidden mt-7">
                                    <Slider {...locationSlider} className="locationSlider">
                                        <div>
                                            <h4 className="text-[28px] font-sans font-bold text-center border-t-[1px] border-b-[1px] border-white py-1 mb-2 uppercase">USA</h4>
                            ...
                            <div>
                                <Image quality={75} src={LocationWorld} alt='Infinity Animations' className='hidden lg:block' />
                            </div>
                        </div>
                    </div>
                </div>
